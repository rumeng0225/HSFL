...
https://github.com/apple/ml-cvnets/blob/main/cvnets/models/classification/.py
...
class MobileViT(nn.Module):
    ...
    def __init__(self, model_cfg: Dict, num_classes: int = 1000):
        ...
        if 0.0 < model_cfg["cls_dropout"] < 1.0:
            self.dropout = nn.Dropout(p=model_cfg["cls_dropout"])
        self.fc = nn.Linear(in_features=exp_channels, out_features=num_classes)
