...
from modules.clients.FLClientFedAvg import FLClientFedAvg
...
class FLServerFedAvg(ServerBase):
    def __init__(self, args, log_file, log_dir: str):
        super(FLServerFedAvg, self).__init__(log_dir=log_dir, log_file=log_file, total_round=args.total_round)
        self.args = args
    ...
    def init_clients(self):
        ...
        self.clients = [FLClientFedAvg(id=i,
                                       args=self.args,
